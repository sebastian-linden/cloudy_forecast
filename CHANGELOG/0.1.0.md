...
```sh
uv add cloud_forecast
```

### What's in the scaffold

- `src/cloud_forecast/` package with CLI (Typer + Rich), py.typed marker
...
[@sebastian-linden](https://github.com/sebastian-linden) (Sebastian B. Linden) created Cloud Forecast.
