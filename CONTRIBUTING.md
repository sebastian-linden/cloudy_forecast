...
Ready to contribute? Here's how to set up cloudy_forecast for local development.

1. Fork the cloudy_forecast repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/cloudy_forecast.git
   ```
